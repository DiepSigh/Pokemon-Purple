...
MapsLoader::MapsLoader() {
	...
	Floor = new Texture("maps/floor.png", 0, 0, 32, 32);
	Bottom_Table_Left = new Texture("maps/bottom_table_left.png", 0, 0, 32, 32);
	Bottom_Table_Right = new Texture("maps/bottom_table_right.png", 0, 0, 32, 32);
	...
	//redHouse
	rhExit = new Texture("maps/rh_exit.png", 0, 0, 32, 32);
	rhPicture = new Texture("maps/rh_picture.png", 0, 0, 32, 32);
	rhTable1 = new Texture("maps/rh_table1.png", 0, 0, 32, 32);
	rhTable2 = new Texture("maps/rh_table2.png", 0, 0, 32, 32);
	
	//researchLab
	rlBigTableBottomMiddle = new Texture("maps/rl_big_table_bottom_middle.png", 0, 0, 32, 32);
	rlBigTableTopLeft = new Texture("maps/rl_big_table_top_left.png", 0, 0, 32, 32);
	rlBigTableTopMiddle = new Texture("maps/rl_big_table_top_middle.png", 0, 0, 32, 32);
	rlBigTableTopRight = new Texture("maps/rl_big_table_top_right.png", 0, 0, 32, 32);
	...
	rlTableBottomLeft = new Texture("maps/rl_table_bottom_left.png", 0, 0, 32, 32);
	rlTableBottomRight = new Texture("maps/rl_table_bottom_right.png", 0, 0, 32, 32);
	rlBookshelf1 = new Texture("maps/bookshelf1_1.png", 0, 0, 32, 32);
	rlBookshelf2 = new Texture("maps/bookshelf1_2.png", 0, 0, 32, 32);
	...
	pmFloor = new Texture("maps/pm_floor.png", 0, 0, 32, 32);
	pmFloorShadow = new Texture("maps/pm_floor_shadow.png", 0, 0, 32, 32);
	...
	pcFloor = new Texture("maps/pc_floor.png", 0, 0, 32, 32);
	pcFloorShadow = new Texture("maps/pc_floor_shadow.png", 0, 0, 32, 32);
	pcFlower1 = new Texture("maps/pc_flower1.png", 0, 0, 32, 32);
	pcFlower2 = new Texture("maps/pc_flower2.png", 0, 0, 32, 32);
	...
	pcSofaFloor2 = new Texture("maps/pc_sofa_floor2.png", 0, 0, 32, 32);
	...
	psTable3 = new Texture("maps/ps_table3.png", 0, 0, 32, 32);
	psTable4 = new Texture("maps/ps_table4.png", 0, 0, 32, 32);
